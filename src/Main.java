...
public class Main extends JFrame 
{
	...
	private void panelMatrialLists()
	{
		...
		listMaterialPrisMaterialUnit.addListSelectionListener(new ListSelectionListener()
		{
			public void valueChanged(ListSelectionEvent e) 
			{
				if (listMaterialPrisMaterialUnit.getSelectedIndex() == -1)
				{
			        //inget händer
				}
				else
		...
		listMatirialAmount.addListSelectionListener(new ListSelectionListener()
		{
			public void valueChanged(ListSelectionEvent e) 
			{
				if (listMatirialAmount.getSelectedIndex() == -1)
				{
			        //inget händer
				}
				else
		...
		listMaterialMo.addListSelectionListener(new ListSelectionListener()
		{
			public void valueChanged(ListSelectionEvent e) 
			{
				if (listMaterialMo.getSelectedIndex() == -1)
				{
			        //inget händer
				}
				else
		...
		listMaterialAffo.addListSelectionListener(new ListSelectionListener()
		{
			public void valueChanged(ListSelectionEvent e) 
			{
				if (listMaterialAffo.getSelectedIndex() == -1)
				{
			        //inget händer
				}
				else
		...
		listMaterialVinst.addListSelectionListener(new ListSelectionListener()
		{
			public void valueChanged(ListSelectionEvent e) 
			{
				if (listMaterialVinst.getSelectedIndex() == -1)
				{
			        //inget händer
				}
				else
		...
		listMaterialPris.addListSelectionListener(new ListSelectionListener()
		{
			public void valueChanged(ListSelectionEvent e) 
			{
				if (listMaterialPris.getSelectedIndex() == -1)
				{
			        //inget händer
				}
				else
